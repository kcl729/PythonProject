...
'P10':[f'What is the addressable market size for company A if they want to reach {p10_percentage}% of a total of {p10_quantity} units', round((p10_percentage)/100*p10_quantity)], 
'P11':[f'A make-up manufacturer has fixed costs of ${p11_fixedcost}, and sells {p11_units} units yearly, what is the fixed cost per unit?', round(p11_fixedcost/p11_units)], 
