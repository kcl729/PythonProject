...
def check_answer(answer):
    ...
    if solution == answer:
        ...
        reply = f'Incorrect. The correct answer is {problem_dictionary[random_problem_key][1]}. You have a total of {correct_answers_count} correct answers. You have worked on {questions_count} problems so far.'
